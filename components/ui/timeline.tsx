    ...
    >
      <div className="max-w-7xl mx-auto py-7 px-4 md:px-8 lg:px-10">
        ...
        <div className="flex gap-4 items-center">
          <div className="flex gap-2 items-center"><Calendar /><h2>{tripData?.duration}</h2></div>
          <div className="flex gap-2 items-center"><Wallet2 /><h2>{tripData?.budget}</h2></div>
          <div className="flex gap-2 items-center"><Users /><h2>{tripData?.group_size}</h2></div>
        </div>
      </div>
